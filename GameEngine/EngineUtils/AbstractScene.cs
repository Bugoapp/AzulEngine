...
namespace AzulEngine.EngineUtils
{
    ...
    /// </summary>
    /// <typeparam name="T">Representa el index de la capa a utilizar</typeparam>
    public class AbstractScene<T>
    {
        ...
        /// </summary>
        /// <param name="layers">Colección de capas de index T</param>
        ...
        /// <returns>Retorna una instancia de index T</returns>
